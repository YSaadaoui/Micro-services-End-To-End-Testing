...
class CustomerRestControllerTest {
    ...
    void setUp() {
        this.customers = List.of(
                CustomerDto.builder().id(1L).firstName("Zaid").lastName("kamal").email("zaid@gmail.com").build() ,
                CustomerDto.builder().id(2L).firstName("lina").lastName("ben").email("lina@gmail.com").build(),
                CustomerDto.builder().id(3L).firstName("imane").lastName("mansouri").email("imane@gmail.com").build()
        );
    }
    ...
    void shouldSaveCustomer() throws Exception {
        ...
        String expected = """
                {
                  "id":1, "firstName":"Zaid", "lastName":"kamal", "email":"zaid@gmail.com"
